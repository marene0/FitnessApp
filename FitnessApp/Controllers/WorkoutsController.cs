...
namespace FitnessApp.Controllers
{
    public class WorkoutsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("WorkoutId,WorkoutName,Date")] Workout workout)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WorkoutId,WorkoutName,Date")] Workout workout)
        {
